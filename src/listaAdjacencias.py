...
class ListaAdjacencias:
    ...
    def grau(self, v):
        return len(self.lista[v]) #len calcula quantos registros tem no vertice v, como a estrutura é de uma lista de adjacencias, ela vai contar a quantidade de vertices listado(vizinhos de v)
